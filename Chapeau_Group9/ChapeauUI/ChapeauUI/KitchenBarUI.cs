...
namespace ChapeauUI
{
    public partial class KitchenBarUI : Form
    {
        ...
        private void DisplayStock(Category category)
        {
            lv_stock.Items.Clear();
            GetStockItems();
            foreach (ChapeauModel.MenuItem item in menuItems)
        ...
        private void cbox_Kitchen_Category_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "Lunch Main":
                    DisplayStock(Category.LunchMain);
                    break;
                case "Specials":
                    DisplayStock(Category.LunchSpecials);
                    break;
                case "Bites":
                    DisplayStock(Category.LunchBites);
                    break;
                case "Starters":
                    DisplayStock(Category.DinnerStarters);
                    break;
                case "Mains":
                    DisplayStock(Category.DinnerMains);
                    break;
                case "Desserts":
                    DisplayStock(Category.DinnerDesserts);
                    break;
            }
        }
        ...
        private void cmb_Bar_Category_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "Soft Drinks":
                    DisplayStock(Category.SoftDrinks);
                    break;
                case "Hot Drinks":
                    DisplayStock(Category.HotDrinks);
                    break;
                case "Beer":
                    DisplayStock(Category.Beers);
                    break;
                case "Wine":
                    DisplayStock(Category.Wines);
                    break;
            }
        }
