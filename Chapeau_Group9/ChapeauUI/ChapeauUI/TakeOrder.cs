...
namespace ChapeauUI
{
    public partial class TakeOrder : Form
    {
        ...
        {
            List<ChapeauModel.MenuItem> fullMenu = menuItemService.GetMenuItems();
            LoadMenu(fullMenu);


        }
        private void LoadMenu(List<ChapeauModel.MenuItem> menu)
        {
            lstvMenu.Items.Clear();
            foreach (ChapeauModel.MenuItem mt in menu)
            {
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            ChapeauModel.MenuItem chosen = (ChapeauModel.MenuItem)lstvMenu.SelectedItems[0].Tag;
        ...
        {
            List<ChapeauModel.MenuItem> items = menuItemService.GetMenuItems();
            LoadMenu(items);
        }
        ...
        {
            List<ChapeauModel.MenuItem> items = menuItemService.GetForCategory("LunchSpecials");
            LoadMenu(items);
        }

        private void btnLunchBites_Click(object sender, EventArgs e)
        {
            List<ChapeauModel.MenuItem> items = menuItemService.GetForCategory("Lunchbites");
            LoadMenu(items);
        }
        ...
        {
            List<ChapeauModel.MenuItem> items = menuItemService.GetForCategory("DinnerStarters");
            LoadMenu(items);
        }

        private void btnDinnerDesserts_Click(object sender, EventArgs e)
        {
            List<ChapeauModel.MenuItem> items = menuItemService.GetForCategory("DinnerDesserts");
            LoadMenu(items);
        }

        private void btnSoftDrinks_Click(object sender, EventArgs e)
        {
            List<ChapeauModel.MenuItem> items = menuItemService.GetForCategory("SoftDrinks");
            LoadMenu(items);
        }
